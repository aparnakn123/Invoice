  ...
  <body>
    ...
    <div class="container-fluid">
            ...
            <tr>
                <td colspan="2">
                  ...
                  <table id="invoice-item-table" class="table table-bordered">
                    <tr>
                      ...
                      <th width="12.5%" colspan="2">Discount (%)</th>
                    ...
                    <tr>
                      ...
                      <td><select class="form-control input-sm number_only order_item_tax1_rate" name="order_item_tax1_rate[]" id="order_item_tax1_rate1" data-srno="1">
              ...
              <tr>
                <td colspan="2" align="center">
                  ...
                  <button type="button" class="btn btn-info back_to_inv"> Back </button>
                </td>
              </tr>
          </table>
        </div>
      ...
      $(document).ready(function(){
        ...
        //  html_code += '<td><select class="form-control input-sm number_only order_item_tax1_rate" name="order_item_tax1_rate[]" id="order_item_tax1_rate'+count+'" data-srno="'+count+'"><option value="0">0</option><option value="1">1</option><option value="5">5</option><option value="10">10</option></select>';
        ...
        // $("#back_to_inv1").on("click", function() {
                ...
                <td colspan="2">
                  ...
                  <table id="invoice-item-table" class="table table-bordered">
                    ...
                    <tr>
                      ...
                      <td><select class="form-control input-sm number_only order_item_tax1_rate" name="order_item_tax1_rate[]" id="order_item_tax1_rate<?php echo $m; ?>" data-srno="1">
                              <option value="0" <?php if ($sub_row["order_item_tax1_rate"] == 0) echo ' selected="selected"'; ?>>0</option>
                              <option value="1" <?php if ($sub_row["order_item_tax1_rate"] == 1) echo ' selected="selected"'; ?>>1</option>
                              <option value="5" <?php if ($sub_row["order_item_tax1_rate"] == 5) echo ' selected="selected"'; ?>>5</option>
                              <option value="10" <?php if ($sub_row["order_item_tax1_rate"] == 10) echo ' selected="selected"'; ?>>10</option>
                      </select></td>
          ...
          foreach($all_result as $row)
          {
            echo '
              <tr>
                ...
                <td><a href="print_invoice.php?pdf=1&id='.$row["order_id"].'">Generate Invoice</a></td>
